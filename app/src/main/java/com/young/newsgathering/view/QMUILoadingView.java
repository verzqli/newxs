...
import com.young.newsgathering.Utils;
...
public class QMUILoadingView extends View {
    ...
    public QMUILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.QMUILoadingView);
        mSize = array.getDimensionPixelSize(R.styleable.QMUILoadingView_qmui_loading_view_size, (int) Utils.dp2px(44));
        mPaintColor = array.getColor(R.styleable.QMUILoadingView_qmui_loading_view_color, Color.WHITE);
        array.recycle();
        initPaint();
    }
